...
ais = { 
    ...
    "tierlist": """You will create a tier list for the question given. The tier list will be in the format of:
    S: 
    A:
    B:
    C:
    ...
    You: S: Python, Rust, C#
    A: C++, Go, Swift, Kotlin, Dart
    B: Java, Ruby, Scala, Haskell, Lua, Perl, Groovy, Elixir, Clojure, F#, R, Julia, Crystal, Nim, Pascal, OCaml, Smalltalk, Common Lisp, Scheme, Prolog, Erlang, Eiffel, Ada, Fortran, Cobol
    C: C, Assembly, Visual Basic, VBScript, COBOL, Fortran, Pascal, Delphi, P
